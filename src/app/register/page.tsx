    ...
    <div className="bg-white px-6 py-24 lg:px-8">
      <div className="mx-auto max-w-3xl text-base/7 text-gray-700">
        ...
        <p className="mt-6 text-xl/8">
          To register for the 2026 StaRGazing Regional Gathering, please
        ...
        <p className="mt-6 text-xl/8">
          Make checks payable to &quot;GLAAM&quot; or &quot;Greater Los Angeles
          Area Mensa&quot;.
        </p>
        <p className="mt-6 text-lg/8 text-gray-500">
          Alternatively, you may instead email your completed registration form
          to
          <br />
          <a
          ...
          <br />
          and send your check payment separately by mail, or{" "}
          <a
            href="https://square.link/u/9YoWqPEI"
