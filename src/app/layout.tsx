...
export const metadata: Metadata = {
  title: {
    ...
    default:
      "StaRGazing 2026 - Greater Los Angeles Area Mensa Regional Gathering",
  },
  description:
    "Scintillating speakers!  Enthralling Entertainment!  Games Galore!  Kids Track!  Most Meals Included!",
};
