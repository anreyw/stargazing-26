        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:py-24 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1 space-y-4">
              ...
              <ul
                role="list"
                className="text-lg font-medium text-pretty text-gray-600 sm:text-xl/8 pl-8 list-disc marker:text-amber-600 space-y-2"
              >
            ...
            />
            <p className="text-xs text-gray-400 pt-24">
