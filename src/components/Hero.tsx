  ...
  return (
    <>
      ...
      <div className="relative isolate overflow-hidden bg-linear-to-b from-violet-100/20">
        ...
        <div className="mx-auto items-center gap-4 px-4 pt-12 font-semibold text-amber-600 md:hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-8 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
            ...
            <div className="mt-6 max-w-xl space-y-4 lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p className="text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">
                Join fellow brilliant minds for the annual{" "}
                <span className="font-bold">
                  Greater Los Angeles Area Mensa{" "}
                  <span className="text-amber-600">Regional Gathering</span>
                </span>{" "}
                during our traditional Presidents’ Day weekend, Friday, February
                13th to Sunday, February 15th, 2026, in lovely Long Beach, CA.
              </p>
              <p className="text-lg font-medium text-pretty text-gray-600 sm:text-xl/8">
              ...
              <ul
                role="list"
                className="list-disc space-y-2 pl-8 text-lg font-medium text-pretty text-gray-600 marker:text-amber-600 sm:text-xl/8"
              >
              ...
              <div className="mt-10 flex items-center gap-x-6">
                ...
                <p className="text-sm lg:text-base">
                  <em>Lock in early bird rates now!</em>
                </p>
              </div>
            </div>
            <Image
            ...
            />
            <p className="pt-24 text-xs text-gray-400">
              Photo of man raising hand by{" "}
              <a href="https://unsplash.com/@priscilladupreez?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">
                Priscilla Du Preez
              </a>{" "}
              on{" "}
              <a href="https://unsplash.com/photos/group-of-people-k3RZK--S-kk?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">
                Unsplash
              </a>
              .
            </p>
